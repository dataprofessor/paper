...
selected_temp = st.empty()
plost.line_chart(
     data=datasets['seattle_weather'],
     x='date',
     y=selected_temp)
selected_temp.multiselect('Select data', ['temp_max', 'temp_min'], ['temp_max', 'temp_min'])
